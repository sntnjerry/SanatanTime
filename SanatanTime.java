...
public class SanatanTime
{
    ...
    public SanatanTime(int[] sanatan_time_start)
    {
        ...
        int[] sanatan_converted_time = christian_to_sanatan_time(christian_current_time.getHours(), christian_current_time.getMinutes(), christian_current_time.getSeconds());
        ...
        this.current_sanatan_time = this.sanatan_ghadis + " Ghadi, " + this.sanatan_pals + " Pal, " + this.sanatan_lipts + " Lipt, " + this.sanatan_vilipts + " Vilipt";
    }
    ...
    private int[] christian_to_sanatan_time(int hours, int minutes, int seconds)
    {
        ...
        int pals = (int)((double)(((minutes_from_ghadi_start * 60) + seconds) / 24));
        int lipts = (int)((double)((((minutes_from_ghadi_start * 60) + seconds) % 24) / 0.4));
        int vilipts = (int)((double)((double)((((minutes_from_ghadi_start * 60) + seconds) % 24) % 0.4) * 150));
        return new int[]{ghadis, pals, lipts, vilipts};
    }
    
    public String convert(Date christian_time)
    {
        int[] sanatan_converted_time = christian_to_sanatan_time(christian_time.getHours(), christian_time.getMinutes(), christian_time.getSeconds());
        return sanatan_converted_time[0] + " Ghadi, " + sanatan_converted_time[1] + " Pal, " + sanatan_converted_time[2] + " Lipt, " + sanatan_converted_time[3] + " Vilipt";
    }
